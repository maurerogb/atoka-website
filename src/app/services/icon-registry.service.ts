...
const Icons = {
  ...
  picture: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M17.9341 21.2568C17.7181 20.0568 16.9861 18.9638 15.8741 18.1808C14.7631 17.3978 13.3471 16.9788 11.8921 17.0008C10.4361 17.0228 9.04006 17.4848 7.96306 18.3008C6.88706 19.1178 6.20306 20.2328 6.03906 21.4378" stroke="#DA7B07"/>
    <path d="M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="#DA7B07" stroke-linecap="round"/>
    <path d="M18 2.5H6C4.067 2.5 2.5 4.067 2.5 6V18C2.5 19.933 4.067 21.5 6 21.5H18C19.933 21.5 21.5 19.933 21.5 18V6C21.5 4.067 19.933 2.5 18 2.5Z" stroke="#DA7B07"/>
    </svg>`,
